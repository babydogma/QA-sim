...
const bugBank = [
  {
    ...
    keywords: ['password', 'empty', 'blank', 'login', 'button', 'disabled', 'validation'],
  ...
  },
  {
    ...
    keywords: ['email', 'invalid', 'format', 'validation', 'error'],
    goodSeverity: ['Major'],
    goodPriority: ['High', 'Medium']
  },
  {
    ...
    keywords: ['loader', 'loading', 'stuck', 'disabled', 'state', 'recover'],
    goodSeverity: ['Major'],
    goodPriority: ['High']
  }
];
